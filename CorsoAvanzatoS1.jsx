...
const SLIDES = [
  ...
  },
  {
    ...
    data: {
      ...
      items: [
        "ChatGPT (25) e Google Gemini (22) sono gli strumenti più usati. Claude: 5 persone. NotebookLM: 7 persone.",
        "26 su 30 usano versioni gratuite. Solo 4 hanno un abbonamento a pagamento (ChatGPT Plus).",
        "Usi principali: creare verifiche/esercizi, cercare informazioni, generare materiali (21 risposte ciascuno). Preparare lezioni: 15. Semplificare testi: 11.",
        "11 su 30 non usano nessun sistema per organizzare i materiali. Solo 3 su 30 hanno mai fatto generare codice all'IA.",
      ],
    },
  },
  {
